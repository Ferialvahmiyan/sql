...
/* How many different times that customer has purchased that product_id in each date */
...
CREATE TEMP TABLE TotalSales AS 
SELECT 
    market_date,
...
DROP TABLE IF EXISTS RankedSales;

CREATE TEMP TABLE RankedSales AS 
SELECT 
    market_date,
    total_sales,
